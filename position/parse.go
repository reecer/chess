...
//
// TODO(reecer): ParseMove - What about promotion captures? or ambiguous promotions?
// BUG(reecer): ParseMove - Illegal move: f7g8 (raw: fxg8=Q)
// BUG(reecer): ParseMove - Illegal move: move axb8=Q+
